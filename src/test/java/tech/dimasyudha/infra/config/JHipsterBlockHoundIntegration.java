...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tech.dimasyudha.infra.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tech.dimasyudha.infra.security.DomainUserDetailsService", "createSpringSecurityUser");
